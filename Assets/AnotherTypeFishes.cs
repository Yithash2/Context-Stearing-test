...
public class AnotherFishType : MonoBehaviour, IKnockbakable, IEnnemy 
{
    ...
    public Action subbHealthEvent {get {return minusHeath;}}
    ...
    void UpdatePatterns(){
        ...
        if(_isCharging && (_state == EnnemyStates.Defensive)){
        ...
        }else if(_isCharging && _forgetTimer < 0){
